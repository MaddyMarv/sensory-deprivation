...
local localizations = {
    ...
    mod_description = {
        en = "Challenge mod that blinds your screen and/or mutes in game audio. Includes a keybound LIDAR scanner to pulse and map terrain.",
    },
    tab_challenge = {
    ...
    enable_deaf = {
        en = "Enable Deaf Challenge (Mute Sound)",
    },
    ...
    lidar_radial_scan_key = {
        en = "360 Radial Scan Keybind",
    },
    lidar_range_meters = {
        en = "Scanner Max Range (Meters)",
    },
    lidar_auto_pulse = {
        en = "Auto-Pulse Scanner",
    },
    lidar_auto_pulse_interval = {
